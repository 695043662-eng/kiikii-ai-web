...
import { X, Loader2, User, Mail, Lock, Phone, ArrowRight, Sparkles, ArrowLeft, Eye, EyeOff } from 'lucide-react';
              ...
              <div className="p-8">
                ...
                <div className="text-center mb-8">
                  <motion.div
                    ...
                    className="w-16 h-16 mx-auto mb-4 rounded-2xl flex items-center justify-center shadow-lg overflow-hidden"
                  >
                    <img src="/logo-main-white.png" alt="Logo" className="w-full h-full object-contain" referrerPolicy="no-referrer-when-downgrade" />
                  </motion.div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          className="h-12 pr-10 bg-white/10 border-white/20 text-white placeholder:text-white/40 focus:border-[rgb(139,158,232)]"
                        />
                        <button
                          type="button"
                    ...
                    >
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="h-14 pl-12 pr-12 bg-white/5 border-white/10 text-white placeholder:text-white/40 focus:border-[rgb(139,158,232)] focus:ring-[rgb(139,158,232)]/20"
                        />
                        <button
                          type="button"
