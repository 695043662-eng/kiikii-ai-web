...
# 1. 添加 clientRequestId 解析（在 userId 后面）
old_parse = '''      userId,
    } = body;'''
new_parse = '''      userId,
...
old_deduct_success = '''      console.log(`[积分扣除] 扣除成功，剩余 ${deductResult.remaining} 积分`);'''
new_deduct_success = '''      console.log(`[积分扣除] 扣除成功，剩余 ${deductResult.remaining} 积分`);
